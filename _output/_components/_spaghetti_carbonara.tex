...
{\includegraphics[width=1cm]{_qr/_spaghetti_carbonara.png} Spaghetti Carbonara}
\ingredients[6]{%
\faSquareO \ \textit{Spaghetti} \small{(\weightOzTog{8} g)} \\
\faSquareO \ \textit{Eggs} \small{(2 large)} \\
\faSquareO \ \textit{Parmessan} \small{(\sfrac{1}{2} cup)} \\
\faSquareO \ \textit{Bacon} \small{(4 slices)} \\
...
\cooking{%
\step{In a large pot of boiling salted water, cook pasta according to package instructions, reserve \sfrac{1}{2} cup water and drain well.}
