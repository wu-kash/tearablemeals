...
\ingredients{%
\faSquareO \ \textit{Ground Beef} (500 g)  \\
\faSquareO \ \textit{Eggs} (2)  \\
\faSquareO \ \textit{Bread Crumbs} (4 tbsp)  \\
\faSquareO \ \textit{BBQ Sauce} (6 tbsp)  \\
\faSquareO \ \textit{Smoked Paprika} (1/2 tsp)  \\
\faSquareO \ \textit{Garlic Powder} (1/4 tsp)  \\
\faSquareO \ \textit{Sweet Potato} (2)  \\
\faSquareO \ \textit{Broccoli Floret} (1 head)  \\
\faSquareO \ \textit{Olive Oil} (4 tbsp)  \\
\faSquareO \ \textit{Salt} (1 1/2 tsp)  \\
