...
\BLOCK{-if ingredient_data['Custom'] is defined}

\VAR{ingredient_data['Custom']}

\BLOCK{-else}

\BLOCK{-if ingredient_data['Units'] == ''}

\faSquareO \ \textit{\VAR{ingredient_name}} (\VAR{ingredient_data['Quantity']})  \\

\BLOCK{-else}

\faSquareO \ \textit{\VAR{ingredient_name}} (\VAR{ingredient_data['Quantity']} \VAR{ingredient_data['Units']})  \\
